...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-[#F2ECDF] relative">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-[#0F2642] mb-16">Potencia tu crecimiento con feedback de calidad</h2>
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#CC3B36] transform transition-all duration-300 hover:-translate-y-2">
              <div className="bg-[#CC3B36]/10 p-4 inline-block rounded-full mb-6">
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#0F2642]">Crea Formularios</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#E3562A] transform transition-all duration-300 hover:-translate-y-2">
              <div className="bg-[#E3562A]/10 p-4 inline-block rounded-full mb-6">
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#0F2642]">Comparte Enlaces</h3>
              <p className="text-gray-700">
                Comparte un enlace único con tus participantes para recopilar sus comentarios de manera anónima y sencilla.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#F2B544] transform transition-all duration-300 hover:-translate-y-2">
              <div className="bg-[#F2B544]/10 p-4 inline-block rounded-full mb-6">
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#0F2642]">Analiza Resultados</h3>
              <p className="text-gray-700">
